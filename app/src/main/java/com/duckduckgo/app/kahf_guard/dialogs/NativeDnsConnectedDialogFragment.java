...
public class NativeDnsConnectedDialogFragment extends DialogFragment {
    private @Nullable DialogOnDismiss _onDismissListener;

    // Empty constructor required for Fragment instantiation
    public NativeDnsConnectedDialogFragment(){
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View dialogView = inflater.inflate(R.layout.dialog_native_dns_connected_fragment, null);
        ...
        //set button
        dialogView.findViewById(R.id.button_ok).setOnClickListener(view -> dialog.cancel());
        return dialog;
    }
